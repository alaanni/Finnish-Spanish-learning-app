...
## Toiminnallisuudet
- Rekisteröityminen oppilaana tai opettajana
- Kirjautuminen
- Oppilas:
  ...
  - näkee harjoituksille annettujen arviointien keskiarvon
- Opettaja:
  ...
  - näkee sekä numeeriset että kirjalliset arviot omista harjoituksistaan
